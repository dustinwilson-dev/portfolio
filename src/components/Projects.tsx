              ...
              <div className="z-10 sm:order-2 sm:col-span-6">
                <h3>
                  <a
                    ...
                    aria-label="Blue Ribbon IT Services Website (opens in a new tab)"
                  >
            ...
            <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
              ...
              <div className="z-10 sm:order-2 sm:col-span-6">
                <h3>
                  <a
                    className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300 group/link text-base"
                    href="https://doc-rag-demo.vercel.app/"
                    target="_blank"
                    rel="noreferrer noopener"
                    aria-label="AI Rag Chat App (opens in a new tab)"
                  >
                    <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                    <span>
                      AI Rag Chat App
                ...
                <p className="mt-2 text-sm leading-normal">
                  Built a full-stack RAG-style document Q&A app where users
                  upload documents and ask questions grounded in their own
                  content. Implemented ingestion (chunking + embeddings),
                  semantic retrieval of the most relevant chunks, and real-time
                  streamed responses using Next.js + TypeScript and OpenAI’s
                  API, with Postgres (Neon) for persistence. Added session-based
                  document isolation via cookies, a clean API layer for
                  upload/retrieve/delete, and a polished UI with dark mode.
                </p>
                <ul
                  className="mt-2 flex flex-wrap"
                  aria-label="Technologies used:"
              ...
              <Image
                src="/doc-rag-demo.vercel.app_darkmode.png"
                alt="AI Rag Chat App Project Landing Page"
                className="aspect-video object-cover rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                width={200}
                height={48}
                priority
